...
var colorName$2 = Object.freeze({
	default: colorName,
	__moduleExports: colorName
});

var cssKeywords = ( colorName$2 && colorName ) || colorName$2;
...
var conversions$2 = Object.freeze({
	default: conversions,
...
var conversions$3 = ( conversions$2 && conversions ) || conversions$2;
...
var route$2 = Object.freeze({
	default: route,
	__moduleExports: route
});

var route$3 = ( route$2 && route ) || route$2;
...
models.forEach(function (fromModel) {
	...
	Object.defineProperty(convert[fromModel], 'channels', { value: conversions$3[fromModel].channels });
	Object.defineProperty(convert[fromModel], 'labels', { value: conversions$3[fromModel].labels });
...
var colorConvert$2 = Object.freeze({
...
function submitColors(event) {
    ...
    $.ajax({
        ...
        success: function success(_ref) {
            var background_color = _ref.background_color,
                aa_colors = _ref.aa_colors,
